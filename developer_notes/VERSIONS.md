...
| `claude-codotchi/package.json` | chore: bump version to 2.11.1 |
| `vscode/codotchi-2.11.1.vsix` | Rebuilt VS Code extension artifact for v2.11.1 |
| `pycharm/build/distributions/pycharm-codotchi-2.11.1.zip` | Rebuilt PyCharm plugin artifact for v2.11.1 |
| `opencode-codotchi/opencode-codotchi-2.11.1.zip` | Rebuilt OpenCode plugin zip for v2.11.1 |
| `claude-codotchi/claude-codotchi-2.11.1.zip` | Rebuilt Claude Code plugin zip for v2.11.1 |
...
| File | What changed |
|------|-------------|
| `vscode/package.json` | Version bumped to 1.23.3 |
| `pycharm/build.gradle.kts` | Version bumped to 1.23.3 |
| `pycharm/src/main/resources/META-INF/plugin.xml` | Version bumped to 1.23.3 |
...
| File | What changed |
|------|-------------|
| `vscode/package.json` | Version bumped to 1.23.1; `codotchi.background` moved to first property; `codotchi.customPrimaryColor`, `codotchi.customSecondaryColor`, `codotchi.customBackgroundColor` removed |
| `pycharm/build.gradle.kts` | Version bumped to 1.23.1 |
| `pycharm/src/main/resources/META-INF/plugin.xml` | Version bumped to 1.23.1 |
| `opencode-codotchi/package.json` | Version bumped to 1.23.1 |
| `vscode/src/sidebarProvider.ts` | Removed 3 `e.affectsConfiguration("codotchi.custom*Color")` lines and associated comment |
| `vscode/media/sidebar.js` | `drawBackground()` rewritten: 8px two-layer ground (A), expanded seasonal accents (B), season sky tint stacked on time-of-day overlay (C), winter night moon added |
| `pycharm/src/main/kotlin/com/codotchi/CodotchiSettings.kt` | Removed `customPrimaryColor`, `customSecondaryColor`, `customBackgroundColor` from `State` class, KDoc, and delegating properties |
| `pycharm/src/main/kotlin/com/codotchi/CodotchiConfigurable.kt` | Removed `customPrimaryPanel`, `customSecondaryPanel`, `customBackgroundPanel` fields + UI rows 2/3/4; moved Background combo to row 0; renumbered all rows; removed custom colour lines from `isModified`, `apply`, `reset` |
| `pycharm/src/main/kotlin/com/codotchi/CodotchiBrowserPanel.kt` | Removed `customPrimary`, `customSecondary`, `customBackground` vals and `--codotchi-custom-*` CSS var block |
| `pycharm/src/main/resources/webview/sidebar.js` | `drawBackground()` rewritten to match VS Code (IDE parity) |
| `vscode/codotchi-1.23.1.vsix` | Rebuilt VS Code artifact for v1.23.1 |
| `pycharm/build/distributions/pycharm-codotchi-1.23.1.zip` | Rebuilt PyCharm artifact for v1.23.1 |
| `opencode-codotchi/opencode-codotchi-1.23.1.zip` | Rebuilt OpenCode artifact for v1.23.1 |
...
| File | What changed |
|------|-------------|
| `vscode/package.json` | Version bumped to 1.19.2 |
| `pycharm/build.gradle.kts` | Version bumped to 1.19.2 |
| `pycharm/src/main/resources/META-INF/plugin.xml` | Version bumped to 1.19.2 |
| `opencode-codotchi/package.json` | Version bumped to 1.19.2 |
| `vscode/src/statusBar.ts` | Wrapped hunger and happiness values in `Math.round()` so they display as integers instead of floats in the status bar tooltip |
...
| `opencode-codotchi/package.json` | Version bumped to 1.18.1 |
| `opencode-codotchi/opencode-codotchi-1.18.1.zip` | Rebuilt distributable zip for v1.18.1 |
| `.opencode/skills/git-workflow/SKILL.md` | Added PyCharm build timeout/retry rules; post-build auto-continue rule |
...
| `vscode/media/sprites.js` | Added `legFrame === -1` sentinel to `renderSpriteGrid` — both legs render flush/level (upright neutral stance) when `-1` is passed (BUGFIX-088) |
| `pycharm/src/main/resources/webview/sprites.js` | Mirror of `vscode/media/sprites.js` |
| `vscode/media/sprite_preview.html` | Fixed missing `quadrupedBellySagRows` argument in `renderSpriteGrid` call — quadrupeds now render correctly (BUGFIX-088); pass `legFrame = -1` when animation disabled so preview shows upright neutral stance; default scale changed from 6× to 1× |
| `pycharm/src/main/resources/webview/sprite_preview.html` | Mirror of `vscode/media/sprite_preview.html` |
...
| `vscode/media/sprite_preview.html` | Fixed broken references to removed `SPRITE_BODY_HEIGHT_MULTS`: `canvasSize()` now uses constant max ratio 1.5; `drawCell()` uses `spriteHeightRatio(animal)`; `renderSpriteGrid` call updated to new signature (BUGFIX-087) |
| `pycharm/src/main/resources/webview/spriteConstants.js` | Mirror of `vscode/media/spriteConstants.js` |
| `pycharm/src/main/resources/webview/sprite_preview.html` | Mirror of VS Code `sprite_preview.html` (BUGFIX-087 fix applied) |
| `pycharm/src/main/resources/webview/sprites.js` | Mirror of `vscode/media/sprites.js` |
| `pycharm/src/main/resources/webview/sidebar.js` | Mirror of `vscode/media/sidebar.js` |
| `BUGFIXES.md` | Added BUGFIX-086 (sprite height squash) and BUGFIX-087 (sprite_preview broken after 086) |
