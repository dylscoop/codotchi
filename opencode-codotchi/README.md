...
Download `opencode-codotchi-2.5.10.zip` from the
[Releases page](https://github.com/dylscoop/codotchi/releases), extract it,
then run the installer:

```bash
# macOS / Linux
unzip opencode-codotchi-2.5.10.zip
cd opencode-codotchi-2.5.10
node bin/install.js --install
```

```powershell
# Windows (PowerShell)
Expand-Archive opencode-codotchi-2.5.10.zip
cd opencode-codotchi-2.5.10
node bin/install.js --install
```
