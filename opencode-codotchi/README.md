...
Download `opencode-codotchi-1.23.1.zip` from the
[Releases page](https://github.com/dylscoop/codotchi/releases), extract it,
then run the installer:

```bash
# macOS / Linux
unzip opencode-codotchi-1.23.1.zip
cd opencode-codotchi-1.23.1
node bin/install.js --install
```

```powershell
# Windows (PowerShell)
Expand-Archive opencode-codotchi-1.23.1.zip
cd opencode-codotchi-1.23.1
node bin/install.js --install
```
