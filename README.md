...
1. Download `vscode-gotchi-0.7.5.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.7.5.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.7.5.zip` from the Releases page.
   Do **not** unzip it.
...
npm install
npx vsce package
# produces vscode-gotchi-0.7.5.vsix
```
...
# produces pycharm/build/distributions/pycharm-gotchi-0.7.5.zip
```
...
Current release: **v0.7.5** — built by [dylscoop](https://github.com/dylscoop)
