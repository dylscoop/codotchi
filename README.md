...
1. Download `vscode-gotchi-0.4.1.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.4.1.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.4.1.zip` from the Releases page.
   Do **not** unzip it.
