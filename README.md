...
1. Download `vscode-gotchi-0.6.2.vsix` from the Releases page.
...
1. Download `pycharm-gotchi-0.6.2.zip` from the Releases page.
   Do **not** unzip it.
...
npm install
npx vsce package
# produces vscode-gotchi-0.6.2.vsix
```
...
# produces pycharm/build/distributions/pycharm-gotchi-0.6.2.zip
```
...
Current release: **v0.6.2** — built by [dylscoop](https://github.com/dylscoop)
