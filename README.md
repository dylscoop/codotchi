...
1. Download `vscode-gotchi-0.4.2.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.4.2.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.4.2.zip` from the Releases page.
   Do **not** unzip it.
