...
1. Download `vscode-gotchi-0.3.2.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.3.2.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.3.2.zip` from the Releases page.
   Do **not** unzip it.
...
npm install
npx vsce package
# produces vscode-gotchi-0.3.2.vsix
```
...
# produces pycharm/build/distributions/pycharm-gotchi-0.3.2.zip
```
