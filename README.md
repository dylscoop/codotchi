...
1. Download `codotchi-2.16.9.vsix` from the Releases page.
...
```bash
code --install-extension codotchi-2.16.9.vsix
```

### JetBrains

1. Download `pycharm-codotchi-2.16.9.zip` from the Releases page.
   Do **not** unzip it.
...
# produces pycharm/build/distributions/pycharm-codotchi-2.16.9.zip
```
...
Current release: **v2.16.9** — built by [dylscoop](https://github.com/dylscoop)
