...
1. Download `vscode-gotchi-0.7.3.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.7.3.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.7.3.zip` from the Releases page.
   Do **not** unzip it.
...
npm install
npx vsce package
# produces vscode-gotchi-0.7.3.vsix
```
...
# produces pycharm/build/distributions/pycharm-gotchi-0.7.3.zip
```
...
Current release: **v0.7.3** — built by [dylscoop](https://github.com/dylscoop)
