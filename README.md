...
1. Download `codotchi-2.17.0.vsix` from the Releases page.
...
```bash
code --install-extension codotchi-2.17.0.vsix
```

### JetBrains

1. Download `pycharm-codotchi-2.17.0.zip` from the Releases page.
   Do **not** unzip it.
...
# produces pycharm/build/distributions/pycharm-codotchi-2.17.0.zip
```
...
Current release: **v2.17.0** — built by [dylscoop](https://github.com/dylscoop)
