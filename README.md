...
1. Download `vscode-gotchi-0.3.0.vsix` from the Releases page.
...
```bash
code --install-extension vscode-gotchi-0.3.0.vsix
```

### JetBrains

1. Download `pycharm-gotchi-0.3.0.zip` from the Releases page.
   Do **not** unzip it.
...
npm install
npx vsce package
# produces vscode-gotchi-0.3.0.vsix
```
...
# produces pycharm/build/distributions/pycharm-gotchi-0.3.0.zip
```
