...
1. **Download `pycharm-gotchi-0.10.5.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.10.5.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.10.5.zip     ← installable plugin archive
```
