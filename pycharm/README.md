...
1. **Download `pycharm-codotchi-1.9.1.zip`** from the
...
```text
pycharm/build/distributions/pycharm-codotchi-1.9.1.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-codotchi-1.9.1.zip     ← installable plugin archive
```
