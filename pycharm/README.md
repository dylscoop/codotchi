...
1. **Download `pycharm-gotchi-0.10.3.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.10.3.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.10.3.zip     ← installable plugin archive
```
