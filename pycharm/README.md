...
1. **Download `pycharm-codotchi-1.8.2.zip`** from the
...
```text
pycharm/build/distributions/pycharm-codotchi-1.8.2.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-codotchi-1.8.2.zip     ← installable plugin archive
```
