...
1. **Download `pycharm-gotchi-0.11.2.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.11.2.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.11.2.zip     ← installable plugin archive
```
