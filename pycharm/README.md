...
1. **Download `pycharm-gotchi-0.10.6.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.10.6.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.10.6.zip     ← installable plugin archive
```
