...
1. **Download `pycharm-codotchi-1.14.0.zip`** from the
...
```text
pycharm/build/distributions/pycharm-codotchi-1.14.0.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-codotchi-1.14.0.zip     ← installable plugin archive
```
