...
1. **Download `pycharm-gotchi-0.11.1.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.11.1.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.11.1.zip     ← installable plugin archive
```
