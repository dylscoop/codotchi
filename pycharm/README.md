...
1. **Download `pycharm-gotchi-0.11.0.zip`** from the
...
```text
pycharm/build/distributions/pycharm-gotchi-0.11.0.zip
```
...
└── pycharm/                     ← JetBrains plugin (this package)
    ...
    └── build/distributions/
        └── pycharm-gotchi-0.11.0.zip     ← installable plugin archive
```
